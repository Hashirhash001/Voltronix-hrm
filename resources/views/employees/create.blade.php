...
<div>
    ...
    <div class="pt-5">
        <form id="employeeForm" action="{{ route('employees.store') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div class="panel">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3 mt-5">
                    ...
                    <div>
                        ...
                        <input id="current_age" type="number" name="current_age" class="form-input" placeholder="Age" value="{{ old('current_age') }}"/>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-4">
                    <div>
                        ...
                        <input id="basic_salary" type="number" step="0.01" name="basic_salary" class="form-input" placeholder="0.00" value="{{ old('basic_salary', 0) }}" required/>
                    </div>

                    <div>
                        <label for="allowance">Allowance</label>
                        <input id="allowance" type="number" step="0.01" name="allowance" class="form-input" placeholder="0.00" value="{{ old('allowance', 0) }}"/>
                    </div>

                    <div>
                        <label for="fixed_salary">Fixed Salary</label>
                        <input id="fixed_salary" type="number" step="0.01" name="fixed_salary" class="form-input" placeholder="0.00" value="{{ old('fixed_salary', 0) }}"/>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    <div>
                        ...
                        <input id="iloe_insurance_expiry_date" type="date" name="iloe_insurance_expiry_date" class="form-input" value="{{ old('iloe_insurance_expiry_date') }}"/>
                    </div>

                    <div>
                        <label for="vtnx_trade_license_renewal_date">VTNX Trade License Renewal</label>
                        <input id="vtnx_trade_license_renewal_date" type="date" name="vtnx_trade_license_renewal_date" class="form-input" value="{{ old('vtnx_trade_license_renewal_date') }}"/>
                    </div>

                    <div>
                        <label for="po_box_renewal_date">PO Box Renewal Date</label>
                        <input id="po_box_renewal_date" type="date" name="po_box_renewal_date" class="form-input" value="{{ old('po_box_renewal_date') }}"/>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3 mt-5">
                    <div>
                        ...
                        <input id="soe_card_renewal_date" type="date" name="soe_card_renewal_date" class="form-input" value="{{ old('soe_card_renewal_date') }}"/>
                    </div>

                    <div>
                        <label for="dcd_card_renewal_date">DCD Card Renewal Date</label>
                        <input id="dcd_card_renewal_date" type="date" name="dcd_card_renewal_date" class="form-input" value="{{ old('dcd_card_renewal_date') }}"/>
                    </div>

                    <div>
                        <label for="voltronix_est_card_renewal_date">Voltronix EST Card Renewal</label>
                        <input id="voltronix_est_card_renewal_date" type="date" name="voltronix_est_card_renewal_date" class="form-input" value="{{ old('voltronix_est_card_renewal_date') }}"/>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3 mt-5">
                    <div>
                        ...
                        <input id="warehouse_ejari_renewal_date" type="date" name="warehouse_ejari_renewal_date" class="form-input" value="{{ old('warehouse_ejari_renewal_date') }}"/>
                    </div>

                    <div>
                        <label for="camp_ejari_renewal_date">Camp EJARI Renewal Date</label>
                        <input id="camp_ejari_renewal_date" type="date" name="camp_ejari_renewal_date" class="form-input" value="{{ old('camp_ejari_renewal_date') }}"/>
                    </div>

                    <div>
                        <label for="workman_insurance_expiry_date">Workman Insurance Expiry</label>
                        <input id="workman_insurance_expiry_date" type="date" name="workman_insurance_expiry_date" class="form-input" value="{{ old('workman_insurance_expiry_date') }}"/>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
                    <div>
                        ...
                        <input id="etisalat_contract_expiry_date" type="date" name="etisalat_contract_expiry_date" class="form-input" value="{{ old('etisalat_contract_expiry_date') }}"/>
                    </div>

                    <div>
                        <label for="dewa_details">DEWA Details</label>
                        <input id="dewa_details" type="text" name="dewa_details" class="form-input" placeholder="Enter DEWA details" value="{{ old('dewa_details') }}"/>
                    </div>
                </div>
...
<script>
    function calculateTotal() {
        ...
        totalSalaryInput.value = total; // Set hidden input for submission
    }
