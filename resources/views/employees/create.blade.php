            ...
            <div class="panel">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    <div>
                        ...
                        <input id="staff_number" type="text" name="staff_number" class="form-input" placeholder="e.g., EMP001" required value="{{ old('staff_number') }}">
                    </div>
                    <div>
                        <label for="employee_name">Employee Name <span class="text-danger">*</span></label>
                        <input id="employee_name" type="text" name="employee_name" class="form-input" placeholder="Enter full name" required value="{{ old('employee_name') }}">
                    </div>
                    <div>
                        <label for="email">Email <span class="text-danger">*</span></label>
                        <input id="email" type="email" name="email" class="form-input" placeholder="Enter email address" required value="{{ old('email') }}">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3 mt-5">
                    ...
                    <div>
                        ...
                        <select id="status" name="status" class="form-select" required>
                            ...
                            <option value="vacation" @selected(old('status')==='vacation')>Vacation</option>
                ...
                {{-- Status-based fields (NO vacation fields) --}}
                <div id="terminated-fields" class="mt-5 hidden">
                    <label for="termination_date">Termination Date <span class="text-danger">*</span></label>
                    <input id="termination_date" type="date" name="termination_date" class="form-input" value="{{ old('termination_date') }}">
                </div>

                <div id="resigned-fields" class="mt-5 hidden">
                    <label for="resignation_date">Resignation Date <span class="text-danger">*</span></label>
                    <input id="resignation_date" type="date" name="resignation_date" class="form-input" value="{{ old('resignation_date') }}">
                </div>

                {{-- INFO: Vacation dates can be added from the employee show/view page --}}
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                    After creating the employee, you can add vacation periods from the employee's profile page.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <input type="hidden" id="total_salary_input" name="total_salary" value="{{ old('total_salary', 0) }}">
                    </div>
                </div>
...
function toggleStatusFields() {
    ...
    // Clear hidden values to prevent accidental submit
